...
public class BandFileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_band_file);


        mClose = findViewById(R.id.page_file_close);
        ...
        mBandName = findViewById(R.id.page_file_bandname);
